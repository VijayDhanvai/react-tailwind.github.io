function Toast({ visibility, toastTitle, hideToast }) {
  ...
  return (
    <>
      {visibility && (
        <div
          className="flex transition-all    fixed right-2 top-18 items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-green-100 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
          role="alert"
        >
